# kitUP User Acquisition Command Center
...
## 📂 Repository Contents
* `index.html`: The entire decision infrastructure application (Single-file, Zero-backend React/Tailwind/Recharts architecture).
* `PROJECT_CONTEXT.md`: Full technical overview, pipeline schema mappings, and algorithmic boundaries.
* `CASE_STUDY_SUBMISSION.html`: Executive-ready case report for the Growth & UA Leadership team.
